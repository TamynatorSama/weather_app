...
class ForcastModel{
  ...
  final CurrentWeather weatherCondition;
  final List<WeatherForcast> forcastDays;

  ForcastModel({
    required this.currentLocation,required this.forcastDays,required this.weatherCondition
  });


  factory ForcastModel.fromJson()=>ForcastModel.fromJson();
...
class WeatherLocation {
    ...
    factory WeatherLocation.fromJson(String str) => WeatherLocation.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory WeatherLocation.fromMap(Map<String, dynamic> json) => WeatherLocation(
        name: json["name"],
        region: json["region"],
...
class CurrentWeather {
    ...
    factory CurrentWeather.fromJson(String str) => CurrentWeather.fromMap(json.decode(str));
...
class WeatherForcast {
    ...
    factory WeatherForcast.fromJson(String str) => WeatherForcast.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory WeatherForcast.fromMap(Map<String, dynamic> json) => WeatherForcast(
